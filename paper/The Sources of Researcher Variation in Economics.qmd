...
setnames(shtask, c('Control','Task 1: N', 'Share above .05',
                  'Task 2: N','Share above .05',
                  'Task 3: N','Share above .05'))
...
conchange[, .(Increase = mean(R2Effect > .05, na.rm = TRUE)),by = .(Control, ControlSwitch)] |>
