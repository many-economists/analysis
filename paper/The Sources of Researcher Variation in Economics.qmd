...
-   Many-analysts as a way of studying it - mention a bunch of many-analyst studies
    ...
    -   Often focused on just finding dfferences and less on their sources
...
-   What we plan to isolate

-   The multi-stage process

-   The general concept behind what we can identify by comparing task 1 to 2 and task 2 to 3
...
-   Basic background on DACA

-   A few previous studies that look at a similar question but the intent here is not to match

### Recruitment and Attrition

-   How eligibility was defined and why

-   Recruitment processes

-   Show the attrition stages

-   Incentives of participants

-   Discussing how the peer review here differs from real life peer reviews

-   Describe the survey used for collecting responses and the coding process for interpreting those responses

-   Link to OSF of completed data
...
rfield = dat[, .(Researcher_Cats, Q1)]
merge(r12samp_w_q1[Round == 'Task 2'], rfield, by = 'Q1')[, .(table(Researcher_Cats, Correct))]
```
