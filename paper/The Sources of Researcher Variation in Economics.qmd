...
```{r Comparisons of Effect Sizes vs. One's Reviewer Figure}
...
```{r Comparisons of Sample Sizes vs. One's Reviewer Figure}
...
```{r Comparisons of DACA Eligible Sample Sizes vs. One's Reviewer Figure}
...
```{r Comparisons of DACA Non-Eligible Sample Sizes vs. One's Reviewer Figure}
